                ...
                <li class="nav-item dropdown">
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                      <li><a href="view.php?cari=1" class="dropdown-item">Obat Kepala</a></li>
                      <li><a href="view.php?cari=2" class="dropdown-item">Obat Kulit</a></li>
                      <li><a href="view.php?cari=3" class="dropdown-item">Obat Mata</a></li>
                    </ul>
                  </li>
              <li class="nav-item">
